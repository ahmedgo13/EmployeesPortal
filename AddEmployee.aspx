<%@ Page Title="Add New Empolyee" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddEmployee.aspx.cs" Inherits="EmployeeDeps.AddEmpolyee" %>
...
<asp:Content ID="AddEmployee" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <div>
        <asp:Button ID="btnAddEmployee" runat="server" Text="Add Record" CssClass="btn btn-primary" OnClick="btnAddEmployee_Click"/>
